...
Multi-source hypoxia onset prediction for the northern Gulf of Mexico, using [AQUAVIEW](https://aquaview.ai) as the unified discovery and data access layer.

**[Read the blog post →](https://aquaview-dah.github.io/aquaview-hypoxia-demo/)**
...
├── docs/
│   └── index.html              # Blog post + interactive map (GitHub Pages)
├── src/
│   ├── multistation_extract.py # AQUAVIEW discovery + data download
│   └── hypoxia_forecast_pipeline.py  # Feature engineering + XGBoost
├── blog_post_draft.md          # Blog post source (markdown)
├── requirements.txt
└── README.md
```
...
- The blog post and interactive map are served from `docs/index.html` via GitHub Pages.
